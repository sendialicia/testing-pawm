...
export default function PTB1Modul7() {
  ...
  const moduleInfo = {
    title: "PTB1 - Modul 7",
    subtitle: "Laser Terapi dan Elektroterapi",
    description: "Modul ini membahas tentang teknologi laser terapi, elektroterapi, peralatan fisioterapi modern, dan aplikasinya dalam rehabilitasi medis.",
    modulId: "ptb1-modul7"
  };
              ...
              <div className="flex items-start space-x-6 mb-8">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-800 mb-4">
                    Download & Submit Tugas Awal PTB1 - Modul 7
                  </h3>
