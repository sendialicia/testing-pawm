...
export default function PTB1Modul5() {
  ...
  const moduleInfo = {
    title: "PTB1 - Modul 5",
    subtitle: "Elektrokardiografi dan Monitoring Jantung",
    description: "Modul ini membahas tentang teknologi elektrokardiografi (EKG), monitoring jantung, dan peralatan kardiovaskular yang digunakan dalam diagnostik dan monitoring pasien.",
    modulId: "ptb1-modul5"
  };
              ...
              <div className="flex items-start space-x-6 mb-8">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-800 mb-4">
                    Download & Submit Tugas Awal PTB1 - Modul 5
                  </h3>
