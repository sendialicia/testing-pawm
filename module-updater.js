// Template untuk mengupdate semua modul PTB1 4-8
const fs = require('fs');
...
const moduleConfigs = [
  {
    number: 4,
    title: "PTB1 - Modul 4",
    subtitle: "Sistem Ventilator dan Peralatan Respirasi",
    description: "Modul ini membahas tentang sistem ventilator, peralatan respirasi, dan teknologi bantuan pernapasan yang digunakan dalam perawatan intensif."
  },
  {
    number: 5,
    title: "PTB1 - Modul 5", 
    subtitle: "Teknologi Terapi dan Rehabilitasi",
    description: "Modul ini membahas teknologi terapi fisik, rehabilitasi medis, dan peralatan bantu yang digunakan dalam proses pemulihan pasien."
  },
  {
    number: 6,
    title: "PTB1 - Modul 6",
    subtitle: "Sistem Informasi Rumah Sakit (SIRS)",
    description: "Modul ini membahas implementasi sistem informasi rumah sakit, manajemen data pasien, dan integrasi teknologi dalam layanan kesehatan."
  },
  {
    number: 7,
    title: "PTB1 - Modul 7",
    subtitle: "Keamanan dan Maintenance Peralatan Medis",
    description: "Modul ini membahas aspek keamanan, pemeliharaan preventif, dan standar kualitas peralatan medis di lingkungan rumah sakit."
  },
  {
    number: 8,
    title: "PTB1 - Modul 8",
    subtitle: "Teknologi Biomedis Terkini dan Masa Depan",
    description: "Modul ini membahas perkembangan teknologi biomedis terbaru, artificial intelligence dalam medis, dan tren teknologi kesehatan masa depan."
  }
];

function generateModuleTemplate(config) {
  return `'use client';
...
export default function PTB1Modul${config.number}() {
  ...
  const moduleInfo = {
    ...
    modulId: "ptb1-modul${config.number}"
  };
              ...
              <div className="flex items-start space-x-6 mb-8">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-800 mb-4">
                    Download & Submit Tugas Awal ${config.title}
                  </h3>
...
console.log('Module templates generated successfully!');
