...
export default function PTB1Modul6() {
  ...
  const moduleInfo = {
    title: "PTB1 - Modul 6",
    subtitle: "Sistem Infus dan Peralatan Terapi",
    description: "Modul ini membahas tentang sistem infus, pompa infus, peralatan terapi intravena, dan teknologi pemberian obat yang digunakan dalam perawatan pasien.",
    modulId: "ptb1-modul6"
  };
              ...
              <div className="flex items-start space-x-6 mb-8">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-800 mb-4">
                    Download & Submit Tugas Awal PTB1 - Modul 6
                  </h3>
